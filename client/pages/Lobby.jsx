                ...
                <MainContainer>
                    <News>
                        ...
                        <Blurb>
                            ...
                            <Text>
                                <Link text="$5 Archon Chainbound Bo1 Swiss (16 players)" url="https://challonge.com/8fs4vmt9"/>
                                <EventTime>12pm EST, 6pm CEST</EventTime>
                            </Text>
                            <Text>
                                <Link text="$5 Archon Chainbound Bo1 Swiss (16 players)" url="https://challonge.com/3rv1y1s0"/>
                        ...
                        <Blurb>
                            ...
                            <Text>
                                <Link text="$5 Archon Chainbound Bo1 Swiss (16 players)" url="https://challonge.com/ig2xxxr5"/>
                                <EventTime>12pm EST, 6pm CEST</EventTime>
                            </Text>
                            <Text>
                                <Link text="$5 Archon Chainbound Bo1 Swiss (16 players)" url="https://challonge.com/odbjswmw"/>
                                <EventTime>8PM EST, 2AM CEST</EventTime>
                            </Text>
                        </Blurb>
                        <Blurb>
                            ...
                            <Text>
                                <Link text="Free Archon Chainbound Bo1 Swiss (128 players)" url="https://challonge.com/l2ujd82z"/>
                                <EventTime>12pm EST, 6pm CEST</EventTime>
                            </Text>
                        </Blurb>
                    </News>
