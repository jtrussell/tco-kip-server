...
module.exports.init = function(server, options) {
    ...
    server.post('/api/account/password-reset', wrapAsync(async (req, res) => {
        ...
        let response = await util.httpRequest(`https://www.google.com/recaptcha/api/siteverify?secret=6Le2AOQUAAAAAO-T0mghl4eqlWO0rdXl_6cAxXz6&response=${req.body.captcha}`);
        let answer = JSON.parse(response);
